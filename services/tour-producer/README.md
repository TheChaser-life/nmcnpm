...
ECS one-shot task that collects travel tour data from the Travelpayouts API and stores it in S3.
...
2. Calls the Travelpayouts API to fetch tour listings for that country
...
If the Travelpayouts API fails for a currency, the existing S3 data is retained unchanged.
...
```json
{
  ...
  "image_url":     "https://cdn.travelpayouts.com/...",
  "image_key":     "tours/images/USD/abc123def456.jpg",
  "affiliate_url": "https://tp.media/r?...",
  "currency_code": "USD",
  "country_code":  "US",
...
|---|---|---|---|
| `TRAVELPAYOUTS_API_TOKEN` | ✅ | — | Travelpayouts partner API token |
...
cp .env.example .env
# Fill in TRAVELPAYOUTS_API_TOKEN and S3_TOUR_BUCKET
